...
public class MultiScrollView extends Activity {
...
//        a.setLayoutParams(new ViewGroup.LayoutParams(FILL_PARENT, FILL_PARENT));
//        HorizontalScrollView b = new HorizontalScrollView(this);
//        LinearLayout c = new LinearLayout(this);
//        LinearLayout d = (LinearLayout)findViewById(R.id.multiscrolllinear_view);
//        
